...
import cerberus
import schema #local py script
import audit #local py script


OSM_PATH = "bengaluru_sample.osm"
    ...
    if element.tag == 'node':
        ...
        for child in element:
            ...
            if LOWER_COLON.match(child.attrib['k']):
                ...
                if child.attrib['k']=="addr:street" and audit.audit_street_2( child.attrib['k']):
